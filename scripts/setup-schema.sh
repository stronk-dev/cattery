...
add_field katten '{"field":"persoonlijkheid","type":"string","meta":{"interface":"select-dropdown","display":"labels","width":"half","sort":13,"note":"Persoonlijkheid voor de tamagotchi katten op de website","options":{"choices":[{"text":"Lui","value":"lazy"},{"text":"Speels","value":"playful"},{"text":"Nieuwsgierig","value":"curious"},{"text":"Eigenwijs","value":"sassy"},{"text":"Verlegen","value":"shy"},{"text":"Chaotisch","value":"chaotic"}],"allowNone":true},"translations":[{"language":"nl-NL","translation":"Persoonlijkheid"}]},"schema":{}}'
...
add_field kittens '{"field":"persoonlijkheid","type":"string","meta":{"interface":"select-dropdown","display":"labels","width":"half","sort":9,"note":"Persoonlijkheid voor de tamagotchi katten op de website","options":{"choices":[{"text":"Lui","value":"lazy"},{"text":"Speels","value":"playful"},{"text":"Nieuwsgierig","value":"curious"},{"text":"Eigenwijs","value":"sassy"},{"text":"Verlegen","value":"shy"},{"text":"Chaotisch","value":"chaotic"}],"allowNone":true},"translations":[{"language":"nl-NL","translation":"Persoonlijkheid"}]},"schema":{}}'
